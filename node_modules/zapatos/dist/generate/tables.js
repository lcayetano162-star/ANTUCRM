...
config, queryFn) => {
    ...
    rows.forEach(row => {
        ...
        let selectableType = (0, pgTypes_1.tsTypeForPgType)(udtName, enums, 'Selectable', config), JSONSelectableType = (0, pgTypes_1.tsTypeForPgType)(udtName, enums, 'JSONSelectable', config), whereableType = (0, pgTypes_1.tsTypeForPgType)(udtName, enums, 'Whereable', config), insertableType = (0, pgTypes_1.tsTypeForPgType)(udtName, enums, 'Insertable', config), updatableType = (0, pgTypes_1.tsTypeForPgType)(udtName, enums, 'Updatable', config);
